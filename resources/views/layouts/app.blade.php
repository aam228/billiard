...
<div x-data="{ sidebarOpen: false }" class="flex h-screen bg-zinc-200 dark:bg-zinc-800">
    ...
    <nav 
        ...
        class="fixed inset-y-0 left-0 z-30 w-54 transition duration-300 transform bg-white dark:bg-zinc-900/80 backdrop-blur-md lg:translate-x-0 lg:static lg:inset-0 flex flex-col"
    >
        ...
        <div class="p-4 shadow-lg bg-white dark:bg-zinc-900/70">
